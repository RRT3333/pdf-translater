...
Google Cloud Translation API를 사용하여 PDF 문서를 번역하는 CLI 프로그램입니다.
...
Google Cloud Translation API는 사용량에 따라 과금됩니다:

- **무료 할당량**: 월 500,000자 (약 250페이지)
- **유료**: 100만 자당 $20 (약 페이지당 $0.08)
...
**해결 방법**: 
- 무료 할당량을 모두 사용한 경우 다음 달까지 대기
- 또는 Google Cloud Console에서 결제 활성화

### 한글 폰트 표시 문제

번역된 PDF에 한글이 제대로 표시되지 않는 경우:
- Windows: 시스템에 맑은고딕 폰트가 설치되어 있는지 확인
- 사용자 지정 폰트를 사용하려면 코드 수정 필요
